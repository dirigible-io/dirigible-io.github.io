...
![Dirigible Architecture](/img/posts/20180222/architecture.png)
...
1. **_Login_**
    ...
    ![Login](/img/posts/20180222/login.gif)
1. **_Develop_**
    - Project
        1. Create a project
            - Click _**+ -> Project**_

            ![Create Project](/img/posts/20180222/project.gif)

    - Database table
        1. Generate a _**Database Table**_
            - Right-click _**New > Generate > Database table**_
            ![Generate a Database Table](/img/posts/20180222/generate.gif)
