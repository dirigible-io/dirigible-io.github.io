...
| Variable                           | Default                                              | Purpose                                                                                                                                                                                                                                                                                                                                                                                                 |
| ---------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DIRIGIBLE_CORS_ALLOWED_ORIGINS`   | -                                                    | Comma-separated origins or origin patterns that may call the platform cross-origin, e.g. `https://app.example.com,https://*.example.com,capacitor://localhost,tauri://localhost`. Setting it enables CORS on every profile. A port pattern is accepted (`:[8080]`, `:[*]`). A multi-port list `:[8080,8081]` cannot be written, since the value is split on commas - list each port as its own pattern. |
