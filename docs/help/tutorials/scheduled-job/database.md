...
1. Navigate to the [`Database Perspective`](/help/ide/perspectives/database).
1. In the [`Statements View`](/help/ide/views/) enter the following script:
...
1. The table data would be displayed in the [`Result View`](/help/ide/views/).
...
- Be familiar with the [`Database Perspective`](/help/ide/perspectives/database), the [`Statements View`](/help/ide/views/) and the [`Result View`](/help/ide/views/).
