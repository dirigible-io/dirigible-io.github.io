...
1. Navigate to the [`Database Perspective`](/help/ide/perspectives/database) to check that there are new records in the `LOG_EVENTS` table.
...
1. Navigate to the [`Jobs Perspective`](/help/ide/perspectives/jobs) to see a list of the Scheduled Jobs on the instance.
1. Click on the `Enable/Disable` icon to stop the `log` Scheduled Job.

    ![Jobs Perspective](jobs-perspective.png)

1. Navigate to the [`Database Perspective`](/help/ide/perspectives/database) to check that there are no new records in the `LOG_EVENTS` table after the job was disabled.
1. Go back to the [`Jobs Perspective`](/help/ide/perspectives/jobs).
...
1. Navigate back to the [`Database Perspective`](/help/ide/perspectives/database) to check that there was a new record added in the `LOG_EVENTS` table after the job was disabled.
...
- Experience with the [`Jobs Perspective`](/help/ide/perspectives/jobs).
