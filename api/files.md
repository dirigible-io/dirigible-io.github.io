...
- Source: [/io/v3/files.js](https://github.com/dirigiblelabs/api-v3-db/blob/master/io/v3/files.js)
- Facade: [FilesFacade](https://github.com/eclipse/dirigible/blob/master/api/api-facades/api-db/src/main/java/org/eclipse/dirigible/api/v3/io/FilesFacade.java)
- Status: **alpha**
